...
await staroid.fill('#password', 'HL798820y+')
await staroid.click('input[value="Sign in"]')
await new globalThis.Promise(_ => globalThis.setTimeout(_, 1000 * 60))
//await staroid.click('span:has-text("Test drive")', {timeout:0})
//await staroid.click('span:has-text("Launch")')
