public class Surf
{
    public static void main(final java.lang.String[] args)
    {
        try (final var playwright = com.microsoft.playwright.Playwright.create())
        {
            ...
            java.util.concurrent.Executors.newSingleThreadScheduledExecutor().scheduleAtFixedRate(() -> {for (final var page: (java.lang.Iterable<com.microsoft.playwright.Page>)context.pages().stream().skip(1).limit(context.pages().size() - 2)) page.close();}, 0, 10, java.util.concurrent.TimeUnit.MINUTES);
        }
    }
}
