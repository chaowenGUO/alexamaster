...
await context.addCookies([{name:'device', value:'jc7VYKQxoMWrzY7095d3Ir', domain:'www.ebesucher.com', path:'/'}, {name:'logincheck', value:'7060124223151', domain:'www.ebesucher.com', path:'/'}])
