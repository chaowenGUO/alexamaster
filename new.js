...
await frame.click('xpath=//img[@class="rc-image-title-33"][1]')
await frame.click('xpath=//img[@class="rc-image-title-33"][8]')
await frame.click('xpath=//img[@class="rc-image-title-33"][5]')
