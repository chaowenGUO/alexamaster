...
await frame.click('xpath=//img[@class="rc-image-title-33"][1]', {timeout:0})
await frame.click('xpath=//img[@class="rc-image-title-33"][8]', {timeout:0})
await frame.click('xpath=//img[@class="rc-image-title-33"][5]', {timeout:0})
